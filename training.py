...
def run_training():
    ...
    train_dir = '/Users/Chenghui Zhang/Desktop/cats_vs_dogs/cats_vs_dogs/data/train/'
    logs_train_dir = '/Users/Chenghui Zhang/Desktop/zch/logs/train/'
...
def evaluate_all_image():
    # you need to change the directories to yours.
    test_dir = '/Users/Chenghui Zhang/Desktop/cats_vs_dogs/cats_vs_dogs/data/test/'
    N_CLASSES = 2
    print('-------------------------')
